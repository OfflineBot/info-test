...
public class ManualTestBean {
    ...
    public void callController(){
        ...
        Movie toBeChanged = this.movieRepository.findById(movie_5.getId()).get();
        //2. Ändern der Entität.
        toBeChanged.setTitle("Star Wars: Rise of the Skywalker");
        this.movieRepository.save(toBeChanged);
        //3. Überprüfung der Änderung
        log.info("New Title for movie_5 is: "+this.movieRepository.findById(movie_5.getId()).get().getTitle());
